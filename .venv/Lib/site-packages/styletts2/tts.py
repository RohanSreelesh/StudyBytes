...
class StyleTTS2:
    ...
    def load_model(self, model_path=None, config_path=None):
        ...
        def handle_path(config_path_from_file) -> str:
            # package_dir: "C:\Carleton\StudyBytes\.venv\Lib\site-packages\styletts2"
            # config_path_from_file: "Utils/ASR/config.yml" or such
            package_dir = os.path.dirname(os.path.abspath(__file__))
            target_path = os.path.join(package_dir, config_path_from_file)
            return target_path

        # load pretrained ASR model
        ASR_config = self.config.get('ASR_config', False)
        ASR_config = handle_path(ASR_config)
        # print(f"ASR_config: {ASR_config}")
        ...
        ASR_path = handle_path(ASR_path)
        # print(f"ASR_path: {ASR_path}")
        ...
        F0_path = handle_path(F0_path)
        # print(f"F0_path: {F0_path}")
